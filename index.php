...
<div id="wrap">
    ...
    <div id="content">
        ...
        <div class="msg">
            <?php if($picture): ?>
                <img src="member_picture/<?= h($picture); ?>" width="48" height="48" alt=""/>
            <?php endif; ?>
            <p><?= h($message); ?><span class="name">（<?= h($name); ?>）</span></p>
            <p class="day"><a href="view.php?id=<?= h($id); ?>"><?= h($created); ?></a>
                <?php if($_SESSION['id'] === $member_id): ?>
                    [<a href="delete.php?id=<?= h($id); ?>" style="color: #F33;">削除</a>]
                <?php endif; ?>
            </p>
        </div>
        <?php endwhile; ?>
